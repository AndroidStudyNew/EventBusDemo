...
public class MainActivity extends BaseActvity {
    ...
    public void doMain(TestEvent event) {
        Log.e(TAG,"doMain event msg:" + event.getMsg());
    ...
    public void doReceive(TestEvent2 event2) {
        Log.e(TAG,"doReceive event msg:" + event2.getMsg());
    ...
    public void showNetData(TestEvent3 event3) {
        Log.e(TAG,"showNetData event msg:" + event3.getMsg());
